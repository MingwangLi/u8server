...
import com.u8.server.sdk.lehihi.LeHiHiPayResult;
...
@Controller
@Namespace("/pay/lehihi")
public class LeHiHiPayCallbackAction extends UActionSupport{
    ...
    public void payCallback(){
        try{
            LeHiHiPayResult rsp = (LeHiHiPayResult) JsonUtils.decodeJson(data, LeHiHiPayResult.class);
            if(rsp == null){
    ...
    private boolean isSignOK(UChannel channel, LeHiHiPayResult rsp) throws Exception {
        StringBuilder sb = new StringBuilder();
        sb.append("amount=").append(rsp.getAmount())
                .append("&extendsInfo=").append(URLEncoder.encode(rsp.getExtendsInfo(),"UTF-8"))
