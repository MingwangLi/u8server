...
@Controller
@Namespace("/pay/k57")
public class K57PayCallbackAction extends UActionSupport {
    ...
    public void payCallback() throws IOException {
        ...
        for (Iterator iter = requestParams.keySet().iterator(); iter.hasNext(); ) {
            ...
            logger.info("----57k支付回调参数:{}",name+"="+valueStr);
        ...
        if (Integer.valueOf(params.get("order_status")) == 2) {
            ...
            SendAgent.sendCallbackToServer(this.orderManager, order);//通知游戏服务器发放道具
            this.renderState(true);
        }
        renderState(false);
    }
