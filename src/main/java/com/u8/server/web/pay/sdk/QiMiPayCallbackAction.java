...
@Controller
@Namespace("/pay/qimi")
public class QiMiPayCallbackAction extends UActionSupport {
    ...
    public void payCallback() {
        ...
        try {
            ...
            if (rsp == null) {
                Log.e("----Qimi---pay callBack message is null");
            ...
            if ("2".equals(rsp.getOrder_status())) {
                int money = (int) Float.parseFloat(rsp.getMoney()) * 100;
...
//-=================================================================================================
    ...
    public boolean verifyPay(UChannel channel, PayResult rsp) {
        String signSource = "order_id=" + rsp.getOrder_id() +
