...
/**
 * Created by lizhong on 2018/1/30.
 */
public class UCSDK implements ISDKScript {
    ...
    public void onGetOrderID(UUser user, UOrder order, ISDKOrderListener callback) {
        ...
        if(callback != null){
            ...
            String amount = order.getMoney()/100+"";
            String cpOrderId = order.getOrderID()+"";
            String callbackInfo = "";
            String notifyUrl = "";
            StringBuilder sb = new StringBuilder();
            sb.append("accountId=").append(accountId).append("amount=").append(amount).append("callbackInfo=").append(callbackInfo).append("cpOrderId=").append(cpOrderId).append("notifyUrl=").append(notifyUrl).append(user.getChannel().getCpAppKey());
