...
public class StateCode {
    ...
    public static final int CODE_CHANNEL_LOGIN_FAIL = 15;    //渠道登陆关闭
    public static final int CODE_CHANNEL_REG_FAIL = 16;    //渠道注册关闭
    public static final int CODE_CHANNEL_NO_ROLE = 17;    //账户关闭
    public static final int CODE_PAY_CLOSED_Time = 18;           //充值关闭时间
}
